...
import OptionLanguage from '@/components/Modules/LandingPage/OptionLanguage/index'
...
const Footer = () => {
    ...
    return (
        <footer className='w-full text-white bg-black border-t-8 border-stone-900 p-8'>
            <div>
                Question? Call <a href='' class="text-blue-600 hover:underline">0812-8002-7486</a>
            </div>
